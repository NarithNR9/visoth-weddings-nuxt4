...
const ogImage = computed(() => settings.value?.og_image ? assetUrl(settings.value.og_image, { width: 1200, height: 630 }) : '')
const pageTitle = computed(() =>
  `${metaTitle.value} | ${$t("hero.greeting") + " " + $t("hero.valuableGuest")}`
)
useHead({
  title: pageTitle,
